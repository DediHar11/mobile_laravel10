                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-floating mb-3">
                                <input id="email" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" class="form-control" id="floatingInput"
                                    placeholder="Masukan email anda" required>
                                <label for="floatingInput" for="email" :value="__('Email')">Email address</label>
                            </div>
                            <div class="form-floating mb-4">
                                <input id="password" type="password" name="password"
                                required autocomplete="current-password" class="form-control" id="floatingPassword"
                                    placeholder="Masukan password anda" required>
                                <label for="floatingPassword" for="password" :value="__('Password')">Password</label>
                            </div>
